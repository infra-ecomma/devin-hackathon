...
- ALWAYS deliver dual output: save the full audit report as a markdown file (ux-audit-YYYY-MM-DD.md) in the project folder AND present a concise summary in the chat with a link to the file.
